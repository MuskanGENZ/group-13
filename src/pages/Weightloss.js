            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img
                  ...
                  width="100%"
                  height="100%"
                  src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/2704ad38516309.588f9ede0b8c0.gif"
                  aria-hidden="true"
                ...
                <div class="container">
                  <div class="carousel-caption">
                    <h1 className="text-white">30 Minute Yoga Workout For Weight Loss</h1>
...
<h2 className="text-md"><i>How To lose weight?</i></h2>
<p class="lead mb-4 text-muted">
<i>
Yoga is known for its incredible benefits such as increasing flexibility and strength. But, did you know? You can actually practice yoga workout for weight loss.Yes, losing weight.This yoga workout will help burn those annoying pounds off, increasing your body flexibility and energy level at the same time.This list consists of a set of yoga workout for anyone looking to lose weight, improve their flexibility and experience yoga if you’re a total beginner.All you need is a yoga mat, small space, and an open heart!Alright, here is the yoga workout for weight loss and tips on how to do them!
